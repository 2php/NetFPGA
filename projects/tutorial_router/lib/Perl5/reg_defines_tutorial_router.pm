...
sub DEVICE_PROJ_DIR ()  { "tutorial_router"; }
sub DEVICE_PROJ_NAME () { "Tutorial router"; }
sub DEVICE_PROJ_DESC () { "Router for use in tutorial"; }
...
sub DROP_NTH_BASE_ADDR ()        { 0x2000700; }
...
sub DROP_NTH_PKT_EN_REG ()   { 0x2000700;}
sub DROP_NTH_PKT_REG ()      { 0x2000704;}
