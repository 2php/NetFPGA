...
package reg_defines_anti_spoof;
...
@EXPORT = qw(
                ...
                ANTI_SPOOF_AS_PORTS_MAC_HI_REG
                ANTI_SPOOF_AS_MAC_LO_REG
                ANTI_SPOOF_AS_NUM_HITS_REG
                ANTI_SPOOF_AS_NUM_MISSES_REG
                ANTI_SPOOF_AS_MAC_LUT_RD_ADDR_REG
                ANTI_SPOOF_AS_MAC_LUT_WR_ADDR_REG
...
sub DEVICE_PROJ_DIR ()  { "anti_spoof"; }
sub DEVICE_PROJ_NAME () { "Anti Spoof"; }
sub DEVICE_PROJ_DESC () { "Anti Spoof"; }
...
sub ANTI_SPOOF_BASE_ADDR ()      { 0x2000000; }
...
sub ANTI_SPOOF_AS_PORTS_MAC_HI_REG ()      { 0x2000000;}
sub ANTI_SPOOF_AS_MAC_LO_REG ()            { 0x2000004;}
sub ANTI_SPOOF_AS_NUM_HITS_REG ()          { 0x2000008;}
sub ANTI_SPOOF_AS_NUM_MISSES_REG ()        { 0x200000c;}
sub ANTI_SPOOF_AS_MAC_LUT_RD_ADDR_REG ()   { 0x2000010;}
sub ANTI_SPOOF_AS_MAC_LUT_WR_ADDR_REG ()   { 0x2000014;}
