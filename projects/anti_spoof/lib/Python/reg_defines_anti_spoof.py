...
#
# Project: Anti Spoof (anti_spoof)
# Description: Anti Spoof
#
#############################################################
...
def ANTI_SPOOF_BASE_ADDR ():    
    return 0x2000000

def SWITCH_OP_LUT_BASE_ADDR (): 
    return 0x2000100
...
# Name: anti_spoof (ANTI_SPOOF)
# Description: Registers for Anti Spoof Module
# File: projects/anti_spoof/include/anti_spoof.xml
def ANTI_SPOOF_AS_PORTS_MAC_HI_REG ():    
    return 0x2000000

def ANTI_SPOOF_AS_MAC_LO_REG ():          
    return 0x2000004

def ANTI_SPOOF_AS_NUM_HITS_REG ():        
    return 0x2000008

def ANTI_SPOOF_AS_NUM_MISSES_REG ():      
    return 0x200000c

def ANTI_SPOOF_AS_MAC_LUT_RD_ADDR_REG (): 
    return 0x2000010

def ANTI_SPOOF_AS_MAC_LUT_WR_ADDR_REG (): 
    return 0x2000014
...
def SWITCH_OP_LUT_PORTS_MAC_HI_REG ():    
    return 0x2000100

def SWITCH_OP_LUT_MAC_LO_REG ():          
    return 0x2000104
...
def SWITCH_OP_LUT_MAC_LUT_RD_ADDR_REG (): 
    return 0x2000110

def SWITCH_OP_LUT_MAC_LUT_WR_ADDR_REG (): 
    return 0x2000114
...
__main__.nf_regmap.update({
    ...
    0x2000000 : "ANTI_SPOOF_AS_PORTS_MAC_HI_REG",
    0x2000004 : "ANTI_SPOOF_AS_MAC_LO_REG",
    0x2000008 : "ANTI_SPOOF_AS_NUM_HITS_REG",
    0x200000c : "ANTI_SPOOF_AS_NUM_MISSES_REG",
    0x2000010 : "ANTI_SPOOF_AS_MAC_LUT_RD_ADDR_REG",
    0x2000014 : "ANTI_SPOOF_AS_MAC_LUT_WR_ADDR_REG",

    0x2000100 : "SWITCH_OP_LUT_PORTS_MAC_HI_REG",
    0x2000104 : "SWITCH_OP_LUT_MAC_LO_REG",
    0x2000108 : "SWITCH_OP_LUT_NUM_HITS_REG",
    0x200010c : "SWITCH_OP_LUT_NUM_MISSES_REG",
    0x2000110 : "SWITCH_OP_LUT_MAC_LUT_RD_ADDR_REG",
    0x2000114 : "SWITCH_OP_LUT_MAC_LUT_WR_ADDR_REG",
