...
// Tag/address widths
`define ANTI_SPOOF_BLOCK_ADDR_WIDTH     17
`define ANTI_SPOOF_REG_ADDR_WIDTH       6
...
`define ANTI_SPOOF_BLOCK_ADDR     17'h00000
...
`define ANTI_SPOOF_AS_PORTS_MAC_HI     6'h0
`define ANTI_SPOOF_AS_MAC_LO           6'h1
`define ANTI_SPOOF_AS_NUM_HITS         6'h2
`define ANTI_SPOOF_AS_NUM_MISSES       6'h3
`define ANTI_SPOOF_AS_MAC_LUT_RD_ADDR  6'h4
`define ANTI_SPOOF_AS_MAC_LUT_WR_ADDR  6'h5
