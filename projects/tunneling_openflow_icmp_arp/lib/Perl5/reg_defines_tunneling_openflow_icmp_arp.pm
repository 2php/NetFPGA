...
package reg_defines_tunneling_openflow_icmp_arp;
...
@EXPORT = qw(
                ...
                ICMP_REPLY_DONT_TOUCH_SRC_PORT
                ...
                IN_ARB_STATE_REG
                ARP_REPLY_NUM_PKTS_SENT_REG
                ARP_REPLY_NUM_ARP_REQS_DROPPED_REG
                ARP_REPLY_NUM_ARP_REPLIES_SENT_REG
                ...
                WDT_ENABLE_FLG_REG
                WDT_COUNTER_REG
                ICMP_REPLY_NUM_PKTS_SENT_REG
                ICMP_REPLY_NUM_ICMP_REQS_DROPPED_REG
                ICMP_REPLY_NUM_ICMP_REPLIES_SENT_REG
                ICMP_REPLY_ENABLE_REG
                ICMP_REPLY_ETH_ADDR_PORT_0_HI_REG
                ICMP_REPLY_ETH_ADDR_PORT_0_LO_REG
                ICMP_REPLY_ETH_ADDR_PORT_1_HI_REG
                ICMP_REPLY_ETH_ADDR_PORT_1_LO_REG
                ICMP_REPLY_ETH_ADDR_PORT_2_HI_REG
                ICMP_REPLY_ETH_ADDR_PORT_2_LO_REG
                ICMP_REPLY_ETH_ADDR_PORT_3_HI_REG
                ICMP_REPLY_ETH_ADDR_PORT_3_LO_REG
                ICMP_REPLY_IP_ADDR_PORT_0_REG
                ICMP_REPLY_IP_ADDR_PORT_1_REG
                ICMP_REPLY_IP_ADDR_PORT_2_REG
                ICMP_REPLY_IP_ADDR_PORT_3_REG
                DECAP_NUM_PKTS_DECAPPED_REG
                DECAP_NUM_PKTS_UNCHANGED_REG
                DECAP_NUM_PKTS_PROCESSED_REG
                DECAP_ENABLE_REG
                DECAP_IP_PROTO_REG
                ENCAP_0_ENABLE_REG
                ENCAP_0_TAG_REG
                ...
                ENCAP_0_SRC_IP_REG
                ENCAP_0_DST_IP_REG
                ENCAP_0_TTL_PROTO_REG
                ENCAP_0_TOS_REG
                ENCAP_0_SRC_MAC_HI_REG
                ENCAP_0_SRC_MAC_LO_REG
                ENCAP_0_DST_MAC_HI_REG
                ENCAP_0_DST_MAC_LO_REG
                ENCAP_1_ENABLE_REG
                ENCAP_1_TAG_REG
                ENCAP_1_PORTS_REG
                ENCAP_1_SRC_IP_REG
                ENCAP_1_DST_IP_REG
                ENCAP_1_TTL_PROTO_REG
                ENCAP_1_TOS_REG
                ENCAP_1_SRC_MAC_HI_REG
                ENCAP_1_SRC_MAC_LO_REG
                ENCAP_1_DST_MAC_HI_REG
                ENCAP_1_DST_MAC_LO_REG
                ENCAP_2_ENABLE_REG
                ENCAP_2_TAG_REG
                ENCAP_2_PORTS_REG
                ENCAP_2_SRC_IP_REG
                ENCAP_2_DST_IP_REG
                ENCAP_2_TTL_PROTO_REG
                ENCAP_2_TOS_REG
                ENCAP_2_SRC_MAC_HI_REG
                ENCAP_2_SRC_MAC_LO_REG
                ENCAP_2_DST_MAC_HI_REG
                ENCAP_2_DST_MAC_LO_REG
                ENCAP_3_ENABLE_REG
                ENCAP_3_TAG_REG
                ENCAP_3_PORTS_REG
                ENCAP_3_SRC_IP_REG
                ENCAP_3_DST_IP_REG
                ENCAP_3_TTL_PROTO_REG
                ENCAP_3_TOS_REG
                ENCAP_3_SRC_MAC_HI_REG
                ENCAP_3_SRC_MAC_LO_REG
                ENCAP_3_DST_MAC_HI_REG
                ENCAP_3_DST_MAC_LO_REG
...
sub DEVICE_PROJ_DIR ()  { "tunneling_openflow_icmp_arp"; }
sub DEVICE_PROJ_NAME () { "Tunneling OpenFlow Switch"; }
sub DEVICE_PROJ_DESC () { "Tunneling OpenFlow Switch with ICMP and ARP"; }
...
sub ARP_REPLY_DONT_TOUCH_SRC_PORT ()            { 15;}
...
sub ICMP_REPLY_DONT_TOUCH_SRC_PORT ()           { 17;}
...
sub ARP_REPLY_BASE_ADDR ()                  { 0x2000240; }
sub OPL_PROCESSOR_BASE_ADDR ()              { 0x2000280; }
sub HEADER_PARSER_BASE_ADDR ()              { 0x20002c0; }
sub BRAM_OQ_BASE_ADDR ()                    { 0x2000300; }
sub WDT_BASE_ADDR ()                        { 0x2000400; }
sub ICMP_REPLY_BASE_ADDR ()                 { 0x2000500; }
sub MATCH_ARBITER_BASE_ADDR ()              { 0x2000540; }
sub EXACT_MATCH_BASE_ADDR ()                { 0x2000580; }
sub DECAP_BASE_ADDR ()                      { 0x20005c0; }
sub ENCAP_0_BASE_ADDR ()                    { 0x2000800; }
sub ENCAP_1_BASE_ADDR ()                    { 0x2000840; }
sub ENCAP_2_BASE_ADDR ()                    { 0x20008c0; }
sub ENCAP_3_BASE_ADDR ()                    { 0x2000980; }
...
# File: projects/tunneling_openflow_icmp_arp/include/arp_reply.xml
sub ARP_REPLY_NUM_PKTS_SENT_REG ()          { 0x2000240;}
sub ARP_REPLY_NUM_ARP_REQS_DROPPED_REG ()   { 0x2000244;}
sub ARP_REPLY_NUM_ARP_REPLIES_SENT_REG ()   { 0x2000248;}
sub ARP_REPLY_ENABLE_REG ()                 { 0x200024c;}
sub ARP_REPLY_ETH_ADDR_PORT_0_HI_REG ()     { 0x2000250;}
sub ARP_REPLY_ETH_ADDR_PORT_0_LO_REG ()     { 0x2000254;}
sub ARP_REPLY_ETH_ADDR_PORT_1_HI_REG ()     { 0x2000258;}
sub ARP_REPLY_ETH_ADDR_PORT_1_LO_REG ()     { 0x200025c;}
sub ARP_REPLY_ETH_ADDR_PORT_2_HI_REG ()     { 0x2000260;}
sub ARP_REPLY_ETH_ADDR_PORT_2_LO_REG ()     { 0x2000264;}
sub ARP_REPLY_ETH_ADDR_PORT_3_HI_REG ()     { 0x2000268;}
sub ARP_REPLY_ETH_ADDR_PORT_3_LO_REG ()     { 0x200026c;}
sub ARP_REPLY_IP_ADDR_PORT_0_REG ()         { 0x2000270;}
sub ARP_REPLY_IP_ADDR_PORT_1_REG ()         { 0x2000274;}
sub ARP_REPLY_IP_ADDR_PORT_2_REG ()         { 0x2000278;}
sub ARP_REPLY_IP_ADDR_PORT_3_REG ()         { 0x200027c;}
...
# File: projects/tunneling_openflow_icmp_arp/include/icmp_reply.xml
sub ICMP_REPLY_NUM_PKTS_SENT_REG ()           { 0x2000500;}
sub ICMP_REPLY_NUM_ICMP_REQS_DROPPED_REG ()   { 0x2000504;}
sub ICMP_REPLY_NUM_ICMP_REPLIES_SENT_REG ()   { 0x2000508;}
sub ICMP_REPLY_ENABLE_REG ()                  { 0x200050c;}
sub ICMP_REPLY_ETH_ADDR_PORT_0_HI_REG ()      { 0x2000510;}
sub ICMP_REPLY_ETH_ADDR_PORT_0_LO_REG ()      { 0x2000514;}
sub ICMP_REPLY_ETH_ADDR_PORT_1_HI_REG ()      { 0x2000518;}
sub ICMP_REPLY_ETH_ADDR_PORT_1_LO_REG ()      { 0x200051c;}
sub ICMP_REPLY_ETH_ADDR_PORT_2_HI_REG ()      { 0x2000520;}
sub ICMP_REPLY_ETH_ADDR_PORT_2_LO_REG ()      { 0x2000524;}
sub ICMP_REPLY_ETH_ADDR_PORT_3_HI_REG ()      { 0x2000528;}
sub ICMP_REPLY_ETH_ADDR_PORT_3_LO_REG ()      { 0x200052c;}
sub ICMP_REPLY_IP_ADDR_PORT_0_REG ()          { 0x2000530;}
sub ICMP_REPLY_IP_ADDR_PORT_1_REG ()          { 0x2000534;}
sub ICMP_REPLY_IP_ADDR_PORT_2_REG ()          { 0x2000538;}
sub ICMP_REPLY_IP_ADDR_PORT_3_REG ()          { 0x200053c;}
...
sub DECAP_NUM_PKTS_DECAPPED_REG ()    { 0x20005c0;}
sub DECAP_NUM_PKTS_UNCHANGED_REG ()   { 0x20005c4;}
sub DECAP_NUM_PKTS_PROCESSED_REG ()   { 0x20005c8;}
sub DECAP_ENABLE_REG ()               { 0x20005cc;}
sub DECAP_IP_PROTO_REG ()             { 0x20005d0;}

# Name: encap_v2 (ENCAP_0)
# Description: Encapsulation Registers
# File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
sub ENCAP_0_ENABLE_REG ()       { 0x2000800;}
sub ENCAP_0_TAG_REG ()          { 0x2000804;}
sub ENCAP_0_PORTS_REG ()        { 0x2000808;}
sub ENCAP_0_SRC_IP_REG ()       { 0x200080c;}
sub ENCAP_0_DST_IP_REG ()       { 0x2000810;}
sub ENCAP_0_TTL_PROTO_REG ()    { 0x2000814;}
sub ENCAP_0_TOS_REG ()          { 0x2000818;}
sub ENCAP_0_SRC_MAC_HI_REG ()   { 0x200081c;}
sub ENCAP_0_SRC_MAC_LO_REG ()   { 0x2000820;}
sub ENCAP_0_DST_MAC_HI_REG ()   { 0x2000824;}
sub ENCAP_0_DST_MAC_LO_REG ()   { 0x2000828;}

# Name: encap_v2 (ENCAP_1)
# Description: Encapsulation Registers
# File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
sub ENCAP_1_ENABLE_REG ()       { 0x2000840;}
sub ENCAP_1_TAG_REG ()          { 0x2000844;}
sub ENCAP_1_PORTS_REG ()        { 0x2000848;}
sub ENCAP_1_SRC_IP_REG ()       { 0x200084c;}
sub ENCAP_1_DST_IP_REG ()       { 0x2000850;}
sub ENCAP_1_TTL_PROTO_REG ()    { 0x2000854;}
sub ENCAP_1_TOS_REG ()          { 0x2000858;}
sub ENCAP_1_SRC_MAC_HI_REG ()   { 0x200085c;}
sub ENCAP_1_SRC_MAC_LO_REG ()   { 0x2000860;}
sub ENCAP_1_DST_MAC_HI_REG ()   { 0x2000864;}
sub ENCAP_1_DST_MAC_LO_REG ()   { 0x2000868;}

# Name: encap_v2 (ENCAP_2)
# Description: Encapsulation Registers
# File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
sub ENCAP_2_ENABLE_REG ()       { 0x20008c0;}
sub ENCAP_2_TAG_REG ()          { 0x20008c4;}
sub ENCAP_2_PORTS_REG ()        { 0x20008c8;}
sub ENCAP_2_SRC_IP_REG ()       { 0x20008cc;}
sub ENCAP_2_DST_IP_REG ()       { 0x20008d0;}
sub ENCAP_2_TTL_PROTO_REG ()    { 0x20008d4;}
sub ENCAP_2_TOS_REG ()          { 0x20008d8;}
sub ENCAP_2_SRC_MAC_HI_REG ()   { 0x20008dc;}
sub ENCAP_2_SRC_MAC_LO_REG ()   { 0x20008e0;}
sub ENCAP_2_DST_MAC_HI_REG ()   { 0x20008e4;}
sub ENCAP_2_DST_MAC_LO_REG ()   { 0x20008e8;}

# Name: encap_v2 (ENCAP_3)
# Description: Encapsulation Registers
# File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
sub ENCAP_3_ENABLE_REG ()       { 0x2000980;}
sub ENCAP_3_TAG_REG ()          { 0x2000984;}
sub ENCAP_3_PORTS_REG ()        { 0x2000988;}
sub ENCAP_3_SRC_IP_REG ()       { 0x200098c;}
sub ENCAP_3_DST_IP_REG ()       { 0x2000990;}
sub ENCAP_3_TTL_PROTO_REG ()    { 0x2000994;}
sub ENCAP_3_TOS_REG ()          { 0x2000998;}
sub ENCAP_3_SRC_MAC_HI_REG ()   { 0x200099c;}
sub ENCAP_3_SRC_MAC_LO_REG ()   { 0x20009a0;}
sub ENCAP_3_DST_MAC_HI_REG ()   { 0x20009a4;}
sub ENCAP_3_DST_MAC_LO_REG ()   { 0x20009a8;}
