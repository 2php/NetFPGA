 ...
 * Project: Tunneling OpenFlow Switch (tunneling_openflow_icmp_arp)
 * Description: Tunneling OpenFlow Switch with ICMP and ARP
 *
 ********************************************************/

#ifndef _REG_DEFINES_TUNNELING_OPENFLOW_ICMP_ARP_
#define _REG_DEFINES_TUNNELING_OPENFLOW_ICMP_ARP_
...
#define DEVICE_PROJ_DIR    "tunneling_openflow_icmp_arp"
#define DEVICE_PROJ_NAME   "Tunneling OpenFlow Switch"
#define DEVICE_PROJ_DESC   "Tunneling OpenFlow Switch with ICMP and ARP"
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/output_port_lookup.xml =====

#define FAST_CLOCK_PERIOD                         8


// ===== File: projects/tunneling_openflow_icmp_arp/include/opl_processor.xml =====
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/match_arbiter.xml =====
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/vlan_remover.xml =====
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/arp_reply.xml =====

#define ARP_REPLY_DONT_TOUCH_SRC_PORT             15


// ===== File: projects/tunneling_openflow_icmp_arp/include/wildcard_match.xml =====
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/watchdog.xml =====

#define WDT_CPCI_REG_CTRL                         0x00000008


// ===== File: projects/tunneling_openflow_icmp_arp/include/header_parser.xml =====
...
// ===== File: projects/tunneling_openflow_icmp_arp/include/icmp_reply.xml =====

#define ICMP_REPLY_DONT_TOUCH_SRC_PORT            17


// ===== File: projects/tunneling_openflow_icmp_arp/include/exact_match.xml =====
...
#define ARP_REPLY_BASE_ADDR                 0x2000240
#define OPL_PROCESSOR_BASE_ADDR             0x2000280
#define HEADER_PARSER_BASE_ADDR             0x20002c0
#define BRAM_OQ_BASE_ADDR                   0x2000300
#define WDT_BASE_ADDR                       0x2000400
#define ICMP_REPLY_BASE_ADDR                0x2000500
#define MATCH_ARBITER_BASE_ADDR             0x2000540
#define EXACT_MATCH_BASE_ADDR               0x2000580
#define DECAP_BASE_ADDR                     0x20005c0
#define ENCAP_0_BASE_ADDR                   0x2000800
#define ENCAP_1_BASE_ADDR                   0x2000840
#define ENCAP_2_BASE_ADDR                   0x20008c0
#define ENCAP_3_BASE_ADDR                   0x2000980
...
// Name: arp_reply (ARP_REPLY)
// Description: ARP Reply Registers
// File: projects/tunneling_openflow_icmp_arp/include/arp_reply.xml
#define ARP_REPLY_NUM_PKTS_SENT_REG          0x2000240
#define ARP_REPLY_NUM_ARP_REQS_DROPPED_REG   0x2000244
#define ARP_REPLY_NUM_ARP_REPLIES_SENT_REG   0x2000248
#define ARP_REPLY_ENABLE_REG                 0x200024c
#define ARP_REPLY_ETH_ADDR_PORT_0_HI_REG     0x2000250
#define ARP_REPLY_ETH_ADDR_PORT_0_LO_REG     0x2000254
#define ARP_REPLY_ETH_ADDR_PORT_1_HI_REG     0x2000258
#define ARP_REPLY_ETH_ADDR_PORT_1_LO_REG     0x200025c
#define ARP_REPLY_ETH_ADDR_PORT_2_HI_REG     0x2000260
#define ARP_REPLY_ETH_ADDR_PORT_2_LO_REG     0x2000264
#define ARP_REPLY_ETH_ADDR_PORT_3_HI_REG     0x2000268
#define ARP_REPLY_ETH_ADDR_PORT_3_LO_REG     0x200026c
#define ARP_REPLY_IP_ADDR_PORT_0_REG         0x2000270
#define ARP_REPLY_IP_ADDR_PORT_1_REG         0x2000274
#define ARP_REPLY_IP_ADDR_PORT_2_REG         0x2000278
#define ARP_REPLY_IP_ADDR_PORT_3_REG         0x200027c
...
// Name: icmp_reply (ICMP_REPLY)
// Description: ICMP Reply Registers
// File: projects/tunneling_openflow_icmp_arp/include/icmp_reply.xml
#define ICMP_REPLY_NUM_PKTS_SENT_REG           0x2000500
#define ICMP_REPLY_NUM_ICMP_REQS_DROPPED_REG   0x2000504
#define ICMP_REPLY_NUM_ICMP_REPLIES_SENT_REG   0x2000508
#define ICMP_REPLY_ENABLE_REG                  0x200050c
#define ICMP_REPLY_ETH_ADDR_PORT_0_HI_REG      0x2000510
#define ICMP_REPLY_ETH_ADDR_PORT_0_LO_REG      0x2000514
#define ICMP_REPLY_ETH_ADDR_PORT_1_HI_REG      0x2000518
#define ICMP_REPLY_ETH_ADDR_PORT_1_LO_REG      0x200051c
#define ICMP_REPLY_ETH_ADDR_PORT_2_HI_REG      0x2000520
#define ICMP_REPLY_ETH_ADDR_PORT_2_LO_REG      0x2000524
#define ICMP_REPLY_ETH_ADDR_PORT_3_HI_REG      0x2000528
#define ICMP_REPLY_ETH_ADDR_PORT_3_LO_REG      0x200052c
#define ICMP_REPLY_IP_ADDR_PORT_0_REG          0x2000530
#define ICMP_REPLY_IP_ADDR_PORT_1_REG          0x2000534
#define ICMP_REPLY_IP_ADDR_PORT_2_REG          0x2000538
#define ICMP_REPLY_IP_ADDR_PORT_3_REG          0x200053c
...
// Name: decap (DECAP)
// Description: Decapsulation Registers
// File: projects/tunneling_openflow_icmp_arp/include/decap.xml
#define DECAP_NUM_PKTS_DECAPPED_REG    0x20005c0
#define DECAP_NUM_PKTS_UNCHANGED_REG   0x20005c4
#define DECAP_NUM_PKTS_PROCESSED_REG   0x20005c8
#define DECAP_ENABLE_REG               0x20005cc
#define DECAP_IP_PROTO_REG             0x20005d0

// Name: encap_v2 (ENCAP_0)
// Description: Encapsulation Registers
// File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
#define ENCAP_0_ENABLE_REG       0x2000800
#define ENCAP_0_TAG_REG          0x2000804
#define ENCAP_0_PORTS_REG        0x2000808
#define ENCAP_0_SRC_IP_REG       0x200080c
#define ENCAP_0_DST_IP_REG       0x2000810
#define ENCAP_0_TTL_PROTO_REG    0x2000814
#define ENCAP_0_TOS_REG          0x2000818
#define ENCAP_0_SRC_MAC_HI_REG   0x200081c
#define ENCAP_0_SRC_MAC_LO_REG   0x2000820
#define ENCAP_0_DST_MAC_HI_REG   0x2000824
#define ENCAP_0_DST_MAC_LO_REG   0x2000828

// Name: encap_v2 (ENCAP_1)
// Description: Encapsulation Registers
// File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
#define ENCAP_1_ENABLE_REG       0x2000840
#define ENCAP_1_TAG_REG          0x2000844
#define ENCAP_1_PORTS_REG        0x2000848
#define ENCAP_1_SRC_IP_REG       0x200084c
#define ENCAP_1_DST_IP_REG       0x2000850
#define ENCAP_1_TTL_PROTO_REG    0x2000854
#define ENCAP_1_TOS_REG          0x2000858
#define ENCAP_1_SRC_MAC_HI_REG   0x200085c
#define ENCAP_1_SRC_MAC_LO_REG   0x2000860
#define ENCAP_1_DST_MAC_HI_REG   0x2000864
#define ENCAP_1_DST_MAC_LO_REG   0x2000868

// Name: encap_v2 (ENCAP_2)
// Description: Encapsulation Registers
// File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
#define ENCAP_2_ENABLE_REG       0x20008c0
#define ENCAP_2_TAG_REG          0x20008c4
#define ENCAP_2_PORTS_REG        0x20008c8
#define ENCAP_2_SRC_IP_REG       0x20008cc
#define ENCAP_2_DST_IP_REG       0x20008d0
#define ENCAP_2_TTL_PROTO_REG    0x20008d4
#define ENCAP_2_TOS_REG          0x20008d8
#define ENCAP_2_SRC_MAC_HI_REG   0x20008dc
#define ENCAP_2_SRC_MAC_LO_REG   0x20008e0
#define ENCAP_2_DST_MAC_HI_REG   0x20008e4
#define ENCAP_2_DST_MAC_LO_REG   0x20008e8

// Name: encap_v2 (ENCAP_3)
// Description: Encapsulation Registers
// File: projects/tunneling_openflow_icmp_arp/include/encap_v2.xml
#define ENCAP_3_ENABLE_REG       0x2000980
#define ENCAP_3_TAG_REG          0x2000984
#define ENCAP_3_PORTS_REG        0x2000988
#define ENCAP_3_SRC_IP_REG       0x200098c
#define ENCAP_3_DST_IP_REG       0x2000990
#define ENCAP_3_TTL_PROTO_REG    0x2000994
#define ENCAP_3_TOS_REG          0x2000998
#define ENCAP_3_SRC_MAC_HI_REG   0x200099c
#define ENCAP_3_SRC_MAC_LO_REG   0x20009a0
#define ENCAP_3_DST_MAC_HI_REG   0x20009a4
#define ENCAP_3_DST_MAC_LO_REG   0x20009a8
