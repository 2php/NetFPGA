...
//
//              Tunneling OpenFlow Switch with ICMP and ARP
//
///////////////////////////////////////////////////////////////////////////////
...
// Tag/address widths
`define ARP_REPLY_BLOCK_ADDR_WIDTH                 19
`define ARP_REPLY_REG_ADDR_WIDTH                   4
...
`define DECAP_BLOCK_ADDR_WIDTH                     19
`define DECAP_REG_ADDR_WIDTH                       4
...
`define ENCAP_BLOCK_ADDR_WIDTH                     19
`define ENCAP_REG_ADDR_WIDTH                       4
...
`define ICMP_REPLY_BLOCK_ADDR_WIDTH                19
`define ICMP_REPLY_REG_ADDR_WIDTH                  4
...
`define ARP_REPLY_BLOCK_ADDR                 19'h00009
`define OPL_PROCESSOR_BLOCK_ADDR             19'h0000a
`define HEADER_PARSER_BLOCK_ADDR             19'h0000b
`define BRAM_OQ_BLOCK_ADDR                   17'h00003
`define WDT_BLOCK_ADDR                       17'h00004
`define ICMP_REPLY_BLOCK_ADDR                19'h00014
`define MATCH_ARBITER_BLOCK_ADDR             19'h00015
`define EXACT_MATCH_BLOCK_ADDR               19'h00016
`define DECAP_BLOCK_ADDR                     19'h00017
`define ENCAP_0_BLOCK_ADDR                   19'h00020
`define ENCAP_1_BLOCK_ADDR                   19'h00021
`define ENCAP_2_BLOCK_ADDR                   19'h00023
`define ENCAP_3_BLOCK_ADDR                   19'h00026
...
// File: projects/tunneling_openflow_icmp_arp/include/arp_reply.xml
`define ARP_REPLY_NUM_PKTS_SENT         4'h0
`define ARP_REPLY_NUM_ARP_REQS_DROPPED  4'h1
`define ARP_REPLY_NUM_ARP_REPLIES_SENT  4'h2
`define ARP_REPLY_ENABLE                4'h3
`define ARP_REPLY_ETH_ADDR_PORT_0_HI    4'h4
`define ARP_REPLY_ETH_ADDR_PORT_0_LO    4'h5
`define ARP_REPLY_ETH_ADDR_PORT_1_HI    4'h6
`define ARP_REPLY_ETH_ADDR_PORT_1_LO    4'h7
`define ARP_REPLY_ETH_ADDR_PORT_2_HI    4'h8
`define ARP_REPLY_ETH_ADDR_PORT_2_LO    4'h9
`define ARP_REPLY_ETH_ADDR_PORT_3_HI    4'ha
`define ARP_REPLY_ETH_ADDR_PORT_3_LO    4'hb
`define ARP_REPLY_IP_ADDR_PORT_0        4'hc
`define ARP_REPLY_IP_ADDR_PORT_1        4'hd
`define ARP_REPLY_IP_ADDR_PORT_2        4'he
`define ARP_REPLY_IP_ADDR_PORT_3        4'hf
...
`define DECAP_NUM_PKTS_DECAPPED   4'h0
`define DECAP_NUM_PKTS_UNCHANGED  4'h1
`define DECAP_NUM_PKTS_PROCESSED  4'h2
`define DECAP_ENABLE              4'h3
`define DECAP_IP_PROTO            4'h4
...
`define ENCAP_ENABLE      4'h0
`define ENCAP_TAG         4'h1
`define ENCAP_PORTS       4'h2
`define ENCAP_SRC_IP      4'h3
`define ENCAP_DST_IP      4'h4
`define ENCAP_TTL_PROTO   4'h5
`define ENCAP_TOS         4'h6
`define ENCAP_SRC_MAC_HI  4'h7
`define ENCAP_SRC_MAC_LO  4'h8
`define ENCAP_DST_MAC_HI  4'h9
`define ENCAP_DST_MAC_LO  4'ha
...
// File: projects/tunneling_openflow_icmp_arp/include/icmp_reply.xml
`define ICMP_REPLY_NUM_PKTS_SENT          4'h0
`define ICMP_REPLY_NUM_ICMP_REQS_DROPPED  4'h1
`define ICMP_REPLY_NUM_ICMP_REPLIES_SENT  4'h2
`define ICMP_REPLY_ENABLE                 4'h3
`define ICMP_REPLY_ETH_ADDR_PORT_0_HI     4'h4
`define ICMP_REPLY_ETH_ADDR_PORT_0_LO     4'h5
`define ICMP_REPLY_ETH_ADDR_PORT_1_HI     4'h6
`define ICMP_REPLY_ETH_ADDR_PORT_1_LO     4'h7
`define ICMP_REPLY_ETH_ADDR_PORT_2_HI     4'h8
`define ICMP_REPLY_ETH_ADDR_PORT_2_LO     4'h9
`define ICMP_REPLY_ETH_ADDR_PORT_3_HI     4'ha
`define ICMP_REPLY_ETH_ADDR_PORT_3_LO     4'hb
`define ICMP_REPLY_IP_ADDR_PORT_0         4'hc
`define ICMP_REPLY_IP_ADDR_PORT_1         4'hd
`define ICMP_REPLY_IP_ADDR_PORT_2         4'he
`define ICMP_REPLY_IP_ADDR_PORT_3         4'hf
