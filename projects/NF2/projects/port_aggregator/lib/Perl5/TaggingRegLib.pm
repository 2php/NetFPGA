...
sub nftest_reg_compare {
        my ($interface, $register, $exp_val) = @_;

        my $val = nftest_regread_expect($interface, $register, $exp_val);
        if ($val == $exp_val) {
            return 0;
        } else {
            return 1;
