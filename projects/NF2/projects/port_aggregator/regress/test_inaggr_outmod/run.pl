...
# Set the VLAN tag values for modification
nftest_regwrite('nf2c0', VLAN_ADDER_0_VLAN_TAG_REG(), $vlan_tag_out[0]);
nftest_regwrite('nf2c0', VLAN_ADDER_1_VLAN_TAG_REG(), $vlan_tag_out[1]);
nftest_regwrite('nf2c0', VLAN_ADDER_2_VLAN_TAG_REG(), $vlan_tag_out[2]);
nftest_regwrite('nf2c0', VLAN_ADDER_3_VLAN_TAG_REG(), $vlan_tag_out[3]);
#verify the values above
$total_errors += nftest_reg_compare('nf2c0', VLAN_ADDER_0_VLAN_TAG_REG(), $vlan_tag_out[0]);
$total_errors += nftest_reg_compare('nf2c0', VLAN_ADDER_1_VLAN_TAG_REG(), $vlan_tag_out[1]);
$total_errors += nftest_reg_compare('nf2c0', VLAN_ADDER_2_VLAN_TAG_REG(), $vlan_tag_out[2]);
$total_errors += nftest_reg_compare('nf2c0', VLAN_ADDER_3_VLAN_TAG_REG(), $vlan_tag_out[3]);
...
$vlan_id_snd = $vlan_tag[1];
$vlan_id_exp = $vlan_tag_out[2];
