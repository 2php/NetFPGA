...
nftest_regwrite('nf2c0', VLAN_ADDER_0_VLAN_TAG_REG(), $vlan_id[0]);
nftest_regwrite('nf2c0', VLAN_ADDER_1_VLAN_TAG_REG(), $vlan_id[1]);
nftest_regwrite('nf2c0', VLAN_ADDER_2_VLAN_TAG_REG(), $vlan_id[2]);
nftest_regwrite('nf2c0', VLAN_ADDER_3_VLAN_TAG_REG(), $vlan_id[3]);

`sleep 1`;

my $vlan_id_snd = $vlan_id[3];
my $vlan_id_exp = $vlan_id[1];
...
$vlan_id_snd = $vlan_id[2];
$vlan_id_exp = $vlan_id[0];
