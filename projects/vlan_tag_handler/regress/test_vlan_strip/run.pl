...
nftest_regwrite('nf2c0', VLAN_ADDER_0_VLAN_TAG_REG(), $vlan_strip);
nftest_regwrite('nf2c0', VLAN_ADDER_1_VLAN_TAG_REG(), $vlan_strip);
nftest_regwrite('nf2c0', VLAN_ADDER_2_VLAN_TAG_REG(), $vlan_strip);
nftest_regwrite('nf2c0', VLAN_ADDER_3_VLAN_TAG_REG(), $vlan_strip);

`sleep 1`;

my $vlan_id_snd = $vlan_id[1];
my $vlan_id_exp = 0x0000;
