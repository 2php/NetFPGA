...
# this is to test the basic forwarding functionality with drr module
# added to output queue 0.
...
#set up DRR related registers
nftest_regwrite('nf2c0', DRR_OQ_SLOW_FACTOR_REG(),1);
nftest_regwrite('nf2c0', DRR_OQ_QUEUE0_CREDIT_REG(),90);
nftest_regwrite('nf2c0', DRR_OQ_QUEUE1_CREDIT_REG(),90);
nftest_regwrite('nf2c0', DRR_OQ_QUEUE2_CREDIT_REG(),90);
nftest_regwrite('nf2c0', DRR_OQ_QUEUE3_CREDIT_REG(),90);
nftest_regwrite('nf2c0', DRR_OQ_QUEUE4_CREDIT_REG(),90);
nftest_regwrite('nf2c0', DRR_QCLASS_POLICY_REG(),0);
nftest_regwrite('nf2c0', DRR_QCLASS_Q0_TOS_REG(),2);
nftest_regwrite('nf2c0', DRR_QCLASS_Q1_TOS_REG(),0);
nftest_regwrite('nf2c0', DRR_QCLASS_Q2_TOS_REG(),1);
