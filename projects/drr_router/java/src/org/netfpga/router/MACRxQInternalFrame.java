...
public class MACRxQInternalFrame extends javax.swing.JInternalFrame {
    ...
    public MACRxQInternalFrame(NFDevice nf2, Timer timer, int index) {
        ...
        buttons[NFDeviceConsts.MAC_DIS_JUMBO_RX_BIT_NUM] = this.enableJumboCheckBox;
        buttons[NFDeviceConsts.MAC_DISABLE_RX_BIT_NUM] = this.enabledCheckbox;
        invert[NFDeviceConsts.MAC_DISABLE_RX_BIT_NUM] = true;
    ...
    private void setupStatsTable(NFDevice nf2, int index) {
        ...
        aAddresses[1] = NFDeviceConsts.RX_QUEUE_0_NUM_BYTES_PUSHED_REG;
        aAddresses[2] = NFDeviceConsts.RX_QUEUE_0_NUM_PKTS_DROPPED_BAD_REG;
        aAddresses[3] = NFDeviceConsts.RX_QUEUE_0_NUM_PKTS_DROPPED_FULL_REG;
