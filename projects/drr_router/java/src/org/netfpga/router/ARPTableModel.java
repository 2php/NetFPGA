...
public class ARPTableModel extends AbstractTableModel {
    ...
    public ARPTableModel(NFDevice nf2){
        ...
        table = new Object[NFDeviceConsts.ROUTER_ARP_SIZE][COLUMN_NAMES.length];

        for(int i=0; i<NFDeviceConsts.ROUTER_ARP_SIZE; i++){
        ...
        addresses[ARP_TABLE_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_ARP_NEXT_HOP_IP_REG;
        addresses[ARP_TABLE_MAC_HI_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_ARP_MAC_HI_REG;
        addresses[ARP_TABLE_MAC_LO_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_ARP_MAC_LO_REG;

        /* instantiate the table and add the listener */
        arpTableModel = new WideRegTableModel(nf2, addresses,
                                              NFDeviceConsts.ROUTER_OP_LUT_ARP_LUT_WR_ADDR_REG,
                                              NFDeviceConsts.ROUTER_OP_LUT_ARP_LUT_RD_ADDR_REG,
                                              NFDeviceConsts.ROUTER_ARP_SIZE);
    ...
    public int getRowCount() {
        return NFDeviceConsts.ROUTER_ARP_SIZE;
    }
