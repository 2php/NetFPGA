...
public class OQPanel extends javax.swing.JPanel {
    ...
    public OQPanel(NFDevice nf2, Timer timer, int index) {
        ...
        oqByteSizeSliderCtrl = new RegSliderGroupControl(nf2, this.oqByteSizeSlider,
                ...
                NFDeviceConsts.OQ_FULL_THRESH_REG_0+index*256);
        ...
        oqPktSizeSliderCtrl = new RegSliderGroupControl(nf2, this.oqPktSizeSlider,
                ...
                NFDeviceConsts.OQ_MAX_PKTS_IN_Q_REG_0+index*256);
        ...
        ctrlRegGrp = new ControlRegGroup(nf2, NFDeviceConsts.OQ_CONTROL_REG_0+index*256,
                                          buttons, invert);
    ...
    private void setupStatsTable(NFDevice nf2, int index) {
        ...
        index = index* 256;
        aAddresses[0] = NFDeviceConsts.OQ_NUM_PKTS_STORED_REG_0 + index;
        aAddresses[1] = NFDeviceConsts.OQ_NUM_PKT_BYTES_STORED_REG_0 + index;
        aAddresses[2] = NFDeviceConsts.OQ_NUM_PKTS_REMOVED_REG_0 + index;
        aAddresses[3] = NFDeviceConsts.OQ_NUM_PKT_BYTES_REMOVED_REG_0 + index;
        aAddresses[4] = NFDeviceConsts.OQ_NUM_PKTS_DROPPED_REG_0 + index;
        aAddresses[5] = NFDeviceConsts.OQ_NUM_PKTS_IN_Q_REG_0 + index;
        aAddresses[6] = NFDeviceConsts.OQ_NUM_WORDS_IN_Q_REG_0+ index;
