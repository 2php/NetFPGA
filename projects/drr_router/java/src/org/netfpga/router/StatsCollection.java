...
public class StatsCollection {
    ...
    /**
     * @param labelMultiplier the labelMultipler to set
     */
    public void setLabelMultiplier(int labelMultiplier) {
    ...
    public void update(long value, boolean notify){
        ...
        if(valueLabel!=null){
            /* update the label */
            if(labelUnits!=null){
                this.valueLabel.setText(String.valueOf(value*labelMultiplier/labelDivider)+labelUnits);
            } else {
                this.valueLabel.setText(String.valueOf(value*labelMultiplier/labelDivider));
            }
        }
