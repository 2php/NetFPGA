...
public abstract class AbstractRouterQuickstartFrame extends JInternalFrame {
    ...
    private static final String RT_TABLE_KEYWORD = "RT";

    private static final int RT_ENTRY_LENGTH = 6;

    private static final String ARP_TABLE_KEYWORD = "ARP";
    ...
    public AbstractRouterQuickstartFrame(NFDevice nf2, Timer updateTimer,
        ...
        drrPanel = this.getDRRPanel();
        this.routerDetailsScrollPane.setViewportView(detailsPanel);
        this.routerDetailsScrollPane.setName("detailsscrollpane");
        this.routerDRRScrollPane.setViewportView(drrPanel);
        this.routerDRRScrollPane.setName("drrscrollpane");
    ...
    private void setupStatsTable(NFDevice nf2) {
        ...
        aAddresses[0] = NFDeviceConsts.RX_QUEUE_0_NUM_PKTS_STORED_REG;
        aAddresses[1] = NFDeviceConsts.RX_QUEUE_1_NUM_PKTS_STORED_REG;
        aAddresses[2] = NFDeviceConsts.RX_QUEUE_2_NUM_PKTS_STORED_REG;
        aAddresses[3] = NFDeviceConsts.RX_QUEUE_3_NUM_PKTS_STORED_REG;

        aAddresses[4] = NFDeviceConsts.TX_QUEUE_0_NUM_PKTS_SENT_REG;
        aAddresses[5] = NFDeviceConsts.TX_QUEUE_1_NUM_PKTS_SENT_REG;
        aAddresses[6] = NFDeviceConsts.TX_QUEUE_2_NUM_PKTS_SENT_REG;
        aAddresses[7] = NFDeviceConsts.TX_QUEUE_3_NUM_PKTS_SENT_REG;

        /* the MAC output queues are the even numbered queues */
        aAddresses[8] = NFDeviceConsts.OQ_NUM_PKTS_DROPPED_REG_0;
        aAddresses[9] = NFDeviceConsts.OQ_NUM_PKTS_DROPPED_REG_2;
        aAddresses[10] = NFDeviceConsts.OQ_NUM_PKTS_DROPPED_REG_4;
        aAddresses[11] = NFDeviceConsts.OQ_NUM_PKTS_DROPPED_REG_6;
    ...
    private void initComponents() {
        ...
        routerDRRScrollPane = new javax.swing.JScrollPane();
        ...
        routerTabbedPane.addTab("DRR", null, routerDRRScrollPane, "Configures router DRR settings");
    ...
    protected abstract JPanel getDRRPanel();
    ...
    private javax.swing.JScrollPane routerDRRScrollPane;
