...
public class RoutingTableModel extends AbstractTableModel {
    ...
    public RoutingTableModel(NFDevice nf2){
        ...
        table = new Object[NFDeviceConsts.ROUTER_RT_SIZE][COLUMN_NAMES.length];

        for(int i=0; i<NFDeviceConsts.ROUTER_RT_SIZE; i++){
        ...
        addresses[RT_TABLE_NEXT_HOP_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_RT_NEXT_HOP_IP_REG;
        addresses[RT_TABLE_OUTPUT_PORTS_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_RT_OUTPUT_PORT_REG;
        addresses[RT_TABLE_SUBNET_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_RT_IP_REG;
        addresses[RT_TABLE_SUBNET_MASK_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.ROUTER_OP_LUT_RT_MASK_REG;

        /* instantiate the table and add the listener */
        routingTableModel = new WideRegTableModel(nf2, addresses,
                                              NFDeviceConsts.ROUTER_OP_LUT_RT_LUT_WR_ADDR_REG,
                                              NFDeviceConsts.ROUTER_OP_LUT_RT_LUT_RD_ADDR_REG,
                                              NFDeviceConsts.ROUTER_RT_SIZE);
    ...
    public int getRowCount() {
        return NFDeviceConsts.ROUTER_RT_SIZE;
    }
