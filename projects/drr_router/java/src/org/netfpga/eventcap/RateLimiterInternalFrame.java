...
public class RateLimiterInternalFrame extends javax.swing.JInternalFrame {
    ...
    public RateLimiterInternalFrame(NFDevice nf2, Timer timer) {
        ...
        sliderCtrl = new RegSliderGroupControl(nf2, this.rateSlider, this.rateValueLabel, NFDeviceConsts.RATE_LIMIT_SHIFT_REG);
        ...
        ctrlRegGrp = new ControlRegGroup(nf2, NFDeviceConsts.RATE_LIMIT_ENABLE_REG,
                                          buttons, invert);
